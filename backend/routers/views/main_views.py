...
async def main_view(request: Request):
    ...
    return templates.TemplateResponse("pages/main.html", {"request": request, "app_version": app_version})
...
async def overlays_view(request: Request):
    ...
    return templates.TemplateResponse("pages/overlays.html", {"request": request, "cards": cards})
